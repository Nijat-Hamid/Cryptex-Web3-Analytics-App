...
class SlideRightPresenter: UIPresentationController {
    ...
    override var frameOfPresentedViewInContainerView: CGRect{
        return .init(x: 0, y: 0, width: screenSize.width * 0.5, height: screenSize.height)
    }
    
    private var initialFrameForPresentedView: CGRect {
        return CGRect(x: -screenSize.width * 0.5, y: 0, width: screenSize.width * 0.5, height: screenSize.height)
    }
